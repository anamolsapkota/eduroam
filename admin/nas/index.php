...
// Handle AJAX requests (must be before HTML output)
...
// Now include admin shell (this outputs HTML)
$admin_page_title = 'NAS';
include dirname(__DIR__) . '/includes/admin-shell-header.php';
?>

<div class="admin-page-header">
    <div>
        <h1>NAS Management</h1>
        <p>Manage Network Access Server configurations.</p>
    </div>
    <div class="admin-page-actions">
        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#nasModal" onclick="openCreateModal()">
            <i class="fas fa-plus me-2"></i>Add New NAS
        </button>
    </div>
</div>
